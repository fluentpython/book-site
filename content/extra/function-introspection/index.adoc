...
I was very glad when Zope was released in 1998 because I wanted to use Bobo in my software development gigs,
but it was not easy to sell projects in Brazil using an obscure language named after a comedy troupe
and unknown framework with a name that is the Portuguese word for "fool".
