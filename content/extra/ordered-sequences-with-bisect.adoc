...
[source, py]
----
include::code/bisect/bisect_demo.py[tags=BISECT_DEMO]
----
====
...
image::img/bisect/flup_0204.png[alt="Output of `bisect_demo.py`"]
...
image::img/bisect/flup_0205.png[alt="Output of `bisect_demo.py` running `bisect_left`."]
...
[source, python3]
----
include::code/bisect/bisect_insort.py[]
----
====

[[ex_insort_output]]
.Output of <<ex_insort>>
image::img/bisect/flup_0206.png[alt="Output of `bisect_insort.py`."]
