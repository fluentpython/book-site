...
Instead, there is a set of 26 "regional indicator symbols", corresponding to latin letters from A to Z with codes from U+1F1E6 to U+1F1FF."
...
[[rainbow_sec]]
== Rainbow Flag and Modern Families
...
to build and serve an HTML page with that matrix of Unicode family emojis.
You can see it in this site's https://github.com/fluentpython/book-site/blob/main/content/extra/multi-character-emojis/emoji_families.py[repository].
